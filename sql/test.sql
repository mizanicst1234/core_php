...
--
-- Host: 127.0.0.1
-- Generation Time: May 25, 2024 at 10:23 PM
...
INSERT INTO `core_boms` (`id`, `code`, `name`, `product_id`, `qty`, `labour_cost`, `date`, `remark`) VALUES
...
(1, 'Red Striped Cow', 'Bangladesh', '0000-00-00', 'red', 'Na', NULL, 0, 1),
(2, 'Black and White', 'Indian', '1970-01-01', 'White', 'NA', 'black-and-white.jpg', 0, 1),
(3, 'BlackCow', 'Indian', '2021-05-07', 'Black', '', 'blackcow.jpg', 0, 1),
(4, 'kala', 'tjh6r', '2024-05-08', 'white', 'reyh5hy', 'kala.png', 0, 2);
...
(1, 'Jahidul Islam', '45345435435', 'jahid@yahoo.com', '2023-12-05 10:05:22', '2023-12-05 10:05:22', '', '1.png'),
...
--
-- Table structure for table `core_managers`
--

CREATE TABLE `core_managers` (
  `id` int(10) NOT NULL,
...
--
-- Dumping data for table `core_managers`
--

INSERT INTO `core_managers` (`id`, `name`, `product_section_id`, `contact`) VALUES
(1, 'Aminur Rahman ', 0, '01897476847'),
(2, 'Naimur Rahman', 0, '01897466847');
...
(1, 'Speing manufacturer'),
(2, 'Knitting manufacturer');

-- --------------------------------------------------------

--
-- Table structure for table `core_materials_details`
--

CREATE TABLE `core_materials_details` (
  `id` int(10) UNSIGNED NOT NULL,
...
CREATE TABLE `core_mfg_productions` (
  `id` int(10) UNSIGNED NOT NULL,
  `production_datetime` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `bom_id` int(10) UNSIGNED NOT NULL,
  `qty` float NOT NULL,
...
(30, '2024-05-20 00:00:03', '2024-05-20 00:00:03', 2, '', 0),
(31, '2024-05-20 00:00:19', '2024-05-20 00:00:19', 3, 'nn', 34),
(32, '2024-05-20 00:01:46', '2024-05-20 00:01:46', 3, 'nn', 34),
(33, '2024-05-20 00:01:53', '2024-05-20 00:01:53', 3, 'nn', 34);
...
(28, 1, '2024-03-21 00:00:00', '2024-03-24 00:00:00', 'Rampura', 100, 5000, '', 1, 0, 0, '2024-05-20 03:38:15', '2024-05-20 03:38:15'),
...
INSERT INTO `core_products` (`id`, `name`, `offer_price`, `manufacturer_id`, `regular_price`, `description`, `photo`, `product_categories_id`, `product_section_id`, `is_featured`, `star`, `is_brand`, `offer_discount`, `uom_id`, `Quantity`, `barcode`, `created_at`, `updated_at`, `product_type_id`) VALUES
(1, 'Wool (Yarn)', 2200, 1, 2400, 'Yarn Product', '1.jpg', 1, 1, 1, 5, 1, 0, 2, 1, '01250001', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 2),
(2, 'Wool (knit)', 700, 2, 700, 'Knit Product', '2.jpg', 1, 2, 1, 5, 1, 0, 2, 1, '0270002', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 1),
(3, 'Silk (Yarn)', 740, 1, 750, 'Yarn product', '3.jpg', 1, 1, 1, 5, 1, 0, 2, 1, '0174003', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0),
(4, 'Silk (Knit)', 2400, 2, 2450, 'Knit product', '4.jpg', 1, 2, 1, 5, 1, 0, 2, 1, '02240004', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0),
(5, 'Cotton (Yarn)', 70, 1, 72, 'Yarn Product', '5.jpg', 1, 1, 1, 5, 1, 0, 2, 1, '017001', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0),
(6, 'Cotton (knit)', 450, 2, 500, 'Knit  Product', '6.jpg', 1, 2, 1, 5, 1, 0, 2, 1, '0245002', '0000-00-00 00:00:00', '0000-00-00 00:00:00', 0);
...
(1, 'Natural Fiber', 3, '2024-05-18 15:03:50', NULL),
(2, 'Synthetic Fiber', 3, '2024-05-18 15:03:55', NULL);

-- --------------------------------------------------------

--
-- Table structure for table `core_product_categoriess`
--

CREATE TABLE `core_product_categoriess` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(45) NOT NULL,
  `section_id` int(10) UNSIGNED NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
...
--
-- Dumping data for table `core_product_categoriess`
--

INSERT INTO `core_product_categoriess` (`id`, `name`, `section_id`, `created_at`, `updated_at`) VALUES
(1, 'Natural Fiber', 1, '2024-05-19 15:39:01', NULL),
(2, 'Synthetic Fiber', 1, '2024-05-19 15:39:07', NULL);
...
(1, 'Weaving Section', 1, NULL, NULL),
(2, 'Knitting Sections', 1, NULL, NULL),
(3, 'Non woven Section', 1, NULL, NULL);
...
(1, 'Plant Sources', NULL, NULL),
(2, 'Animal Sources', NULL, NULL),
(3, 'Mineral Sources', NULL, NULL);
...
(36, 4, '2024-05-26 00:00:00', '2024-05-26 00:00:00', 'm', 955.5, 0, '', 1, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(37, 3, '2024-05-26 00:00:00', '2024-05-26 00:00:00', 'na', 945, 0, '', 1, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00'),
(38, 2, '2024-05-26 00:00:00', '2024-05-26 00:00:00', 'rampura', 3118.5, 0, '', 1, 0, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
(12, 19, 17, 0, 0, 0, 0),
(13, 20, 17, 0, 0, 0, 0),
(14, 21, 50, 1, 1200, 0, 40),
(15, 26, 50, 3, 345, 0, 100),
(16, 28, 0, 2, 2600, 0, 0),
(17, 29, 51, 2, 2600, 0, 100),
(18, 29, 50, 5, 345, 0, 0),
(19, 30, 6, 1, 450, 0, 0),
(20, 30, 5, 1, 70, 0, 0),
(21, 31, 3, 2, 740, 0, 0),
...
--
-- Table structure for table `core_sellers`
--

CREATE TABLE `core_sellers` (
  `id` int(10) NOT NULL,
  `name` varchar(20) DEFAULT NULL,
...
--
-- Dumping data for table `core_sellers`
--

INSERT INTO `core_sellers` (`id`, `name`, `city`, `contact`) VALUES
(1, 'Txt Minar ', 'Dinajpur', '01897476847'),
(2, 'Txt Abid', 'Rangpur', '01897466847'),
(3, 'Txt Faruk', 'Rangpur', '01897476847'),
(4, 'Txt Jahid', 'Narayangonj,Dhaka', '01897479847');
...
(7, 1, 20, 1, 'Order', '2024-05-23 05:19:49', 2),
...
(14, 50, 3, 3, 'Purchase', '2024-05-19 12:50:57', 3),
(15, 0, 2, 3, 'Purchase', '2024-05-19 23:37:37', 1),
(16, 51, 2, 3, 'Purchase', '2024-05-20 23:07:46', 2),
(17, 50, 5, 3, 'Purchase', '2024-05-20 23:07:46', 2),
(18, 6, 1, 3, 'Purchase', '2024-05-21 01:07:48', 2),
(19, 5, 1, 3, 'Purchase', '2024-05-21 01:07:48', 2),
(20, 3, 2, 3, 'Purchase', '2024-05-21 01:09:25', 2),
(21, 5, 1, 3, 'Purchase', '2024-05-21 01:09:25', 2),
(22, 4, 1, 3, 'Purchase', '2024-05-21 01:09:25', 2),
(23, 2, 1, 3, 'Purchase', '2024-05-21 02:19:54', 2),
(24, 4, 1, 3, 'Purchase', '2024-05-21 02:19:54', 2),
(25, 5, 2, 3, 'Purchase', '2024-05-21 02:19:54', 2),
(26, 3, 1, 3, 'Purchase', '2024-05-22 23:09:21', 3),
(27, 5, 1, 3, 'Purchase', '2024-05-22 23:09:21', 3),
(28, 4, 9, 3, 'Purchase', '2024-05-22 23:11:16', 3),
(29, 5, 2, 3, 'Purchase', '2024-05-25 15:35:20', 2),
(30, 6, 1, 3, 'Purchase', '2024-05-25 15:35:20', 2),
(31, 5, 3, 3, 'Purchase', '2024-05-25 15:52:47', 3),
(32, 2, 1, 3, 'Purchase', '2024-05-25 15:52:47', 3),
(33, 6, 2, 3, 'Purchase', '2024-05-25 15:57:43', 4),
(34, 1, 1, 3, 'Purchase', '2024-05-25 15:59:12', 3),
(35, 2, 1, 3, 'Purchase', '2024-05-25 15:59:12', 3),
(36, 5, 1, 3, 'Purchase', '2024-05-25 15:59:12', 3);
...
(1, 'Txt Minar ', '01897476847', 'minar@gmail.com'),
(2, 'Txt Abid', '01897466847', 'abid@gmail.com'),
(3, 'Txt Faruk', '01897476847', 'faruk@gmail.com'),
(4, 'Txt Jahid', '01897479847', 'jahid@gmail.com');
...
(221, 'mir', 1, '$2y$10$2AbZtnNbqrsEACRBAyHnYeh2yXr4zXeRp2V0r/ktbmsnaXEIfqyDW', 'mir@gmail.com', 'Mizanur Rahman', '2024-05-25 15:27:13', 'mir-gmail-com.png', NULL, 0, NULL, '2024-05-25 21:27:13', '::1', '0000-00-00 00:00:00', '');
...
(1, 'Rampura Warehouse', 'Rampura,Dhaka', '01897476847'),
(2, 'Dhanmandhi Warehouse', 'Dhanmandhi,Dhaka', '01897466847'),
(3, 'Uttra Warehouse', 'Uttra 12/A ,Dhaka', '01897476847'),
(4, 'Narayangonj Warehous', 'Narayangonj,Dhaka', '01897479847'),
(5, 'Dhaka warehouse', 'khulna', '1161606149'),
(6, 'ware house', 'ierojgmnion', 'ingmionav');
...
(1, 'Speing Manufacturer', '08340830'),
(2, 'Knitting Manufacturer', '2345454');
...
--
-- Indexes for table `core_product_categoriess`
--
ALTER TABLE `core_product_categoriess`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `core_product_categoriess`
--
ALTER TABLE `core_product_categoriess`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
