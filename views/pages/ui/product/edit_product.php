...
*/
	if(count($errors)==0){
		...
		$product->product_categories_id=$_POST["cmbProductCategoriesId"];
...
<?php
	...
	$html.=select_field(["label"=>"Product Categories","name"=>"cmbProductCategoriesId","table"=>"product_categoriess","value"=>"$product->product_categories_id"]);
	...
	$html.=input_field(["label"=>"Star","type"=>"text","name"=>"cmbStar","value"=>"$product->star"]);
