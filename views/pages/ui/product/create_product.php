...
*/
	if(count($errors)==0){
		...
		$product->photo=upload($_FILES["filePhoto"], "img",$_POST["txtBarcode"]);
...
<?php
	...
	$html.=select_field(["label"=>"Product Categories","name"=>"cmbProductCategoriesId","table"=>"product_categoriess"]);
