...
<form class='form-horizontal' action='create-purchase' method='post' enctype='multipart/form-data'>
<?php
	$html="";
	$html.=select_field(["label"=>"Supplier","name"=>"cmbSupplierId","table"=>"suppliers"]);
	$html.=input_field(["label"=>"Purchase Date","type"=>"text","name"=>"txtPurchaseDate"]);
	...
	$html.=input_field(["label"=>"Purchase Total","type"=>"text","name"=>"txtPurchaseTotal"]);
