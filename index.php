...
<head>
  ...
  <title>Mir Textiles Limited | Log in </title>
...
<body class="hold-transition login-page" style="background-color:#dfc2c2; ">
<div class="login-box">
  <!-- /.login-logo -->
  <div class="card card-outline card-primary">
    <div class="card-header text-center">
      <a href="#" class="h1" style="font-size:30px;"><b>Mir </b>Textiles Limited</a>
