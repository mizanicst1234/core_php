...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		if($action){
			...
			$html.="<tr><th>Id</th><th>Name</th><th>Mobile</th><th>Email</th><th>Updated At</th><th>Address</th><th>Photo</th></tr>";
		}
		while($customer=$result->fetch_object()){
			$action_buttons = "";
			if($action){
			...
			$html.="<tr><td>$customer->id</td><td>$customer->name</td><td>$customer->mobile</td><td>$customer->email</td></td> $action_buttons</tr>";
		}
		$html.="</table>";
