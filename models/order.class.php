...
";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		if($action){
			$html.="<tr><th>Id</th><th>Customer Id</th><th>Order Date</th><th>Delivery Date</th><th>Shipping Address</th><th>Paid Amount</th><th>Action</th></tr>";
		}else{
		...
		while($order=$result->fetch_object()){
			...
			$html.="<tr><td>$order->id</td><td>$order->customer_id</td><td>$order->order_date</td><td>$order->delivery_date</td><td>$order->shipping_address</td><td>$order->paid_amount</td> $action_buttons</tr>";
		}
		$html.="</table>";
